          ...
          <div className={styles.our_shops}>
            ...
            <Link href="/locations" className={styles.shop_link}>
              <p className={styles.our_text}>
                ...
                пн-пт с 11:00 до 19:00, <br />сб с 11:00 до 18:00,<br /> воскресенье — выходной<br />
                              <strong> Телефон: </strong> +375 17 224-42-63<br />

              </p>
            </Link>
            <Link href="/locations" className={styles.shop_link}>
              <p className={styles.our_text}>
                <strong> Салон  &quot;ЗОЛОТО&quot;</strong><br />
                г. Минск, ул. Сурганова,16<br />
                ст.метро Академия наук<br />
               <strong>  Время работы</strong><br /> пн-пт с 11:00 до 19:00,<br /> сб, вс с 11:00 до 18:00<br />
              <strong> Телефон:  </strong> +375 17 360-76-10,<br/>
+375 29 299-56-18<br />
