  ...
  return (
    <div className={styles.section}>
      ...
      <div className={cn(styles.sliderWrapper, 'container')}>
        <button ref={setPrevEl} className={cn(styles.navButton, styles.navPrev)} aria-label="Назад">
        ...
        <button ref={setNextEl} className={cn(styles.navButton, styles.navNext)} aria-label="Вперёд">
          <svg width="9" height="15" viewBox="0 0 9 15" fill="none">
